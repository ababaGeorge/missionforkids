...
import { P, spacing } from '../../../design/tokens';
import { Label } from '../../../design/Text';

type TabMeta = { name: string; label: string; icon: string };

const TABS: TabMeta[] = [
  { name: 'tasks', label: '任務', icon: '✦' },
  { name: 'review', label: '審核', icon: '◐' },
  { name: 'rewards', label: '禮物', icon: '♡' },
  { name: 'notif', label: '通知', icon: '◉' },
  { name: 'family', label: '設定', icon: '☰' },
];
